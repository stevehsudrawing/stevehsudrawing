...
Some of these original artworks ([§1.1](#11-restricted-works---all-rights-reserved)) contain **invisible digital watermarks** that allow me to trace unauthorized use back to its source. This measure exists to protect my rights as the creator.

## 3. Inquiries

If you wish to use any restricted works ([§1.1](#11-restricted-works---all-rights-reserved)) beyond what is permitted above, please contact me through my email address ([stevehsudrawing@outlook.com](mailto:stevehsudrawing@outlook.com)) or other platform links listed in [my Link-Hub](https://stevehsudrawing.github.io).
